...
/**
 * <p>
 * 		utility-class for {@link java.io.Reader reader}, {@link java.io.InputStream streams}, and
 *		{@link java.nio.ReadableByteChannel channel}
 * </p>
 * 
 * @since JDK 1.8
...
public final class InputUtility {
	...
	/**
	 * <p>reads characters into the buffer as long as the buffer is not completely filled</p>
	 * <p>notice: 
	...
	/**
	 * <p>reads bytes into the buffer as long as the buffer is not completely filled</p>
	 * <p>notice: 
	 * 	<li>proceeds as long as the buffer is not completely filled or an exception is thrown</li>
	 * 	<li>returns the same object which is passed by the parameter buffer</li>
	 * </p>
